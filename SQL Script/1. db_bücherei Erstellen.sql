...
-- -----------------------------------------------------
-- Table `buecherei`.`leser_ort`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`leser_ort` ;

CREATE TABLE IF NOT EXISTS `buecherei`.`leser_ort` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`leser` ;
...
CREATE TABLE IF NOT EXISTS `buecherei`.`leser` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_Leser_leser_ort1_idx` (`leser_ort_ID` ASC),
  CONSTRAINT `fk_Leser_leser_ort1`
    FOREIGN KEY (`leser_ort_ID`)
    REFERENCES `buecherei`.`leser_ort` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`buecher_autor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`buecher_genre` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`buecher_verlage` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`buch` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`ausleihen` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`mitarbeiter` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buecherei`.`reservierungen` ;
